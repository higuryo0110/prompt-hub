...
type A8BannerProps = {
  size?: 'small' | 'small2' | 'medium' | 'wide' | 'rect' | 'rect2' | 'rect3' | 'rect4' | 'rect5' | 'rect6' | 'rect-both' | 'leaderboard' | 'leaderboard2' | 'leaderboard3'
  className?: string
}
...
export default function A8Banner({ size = 'small', className = '' }: A8BannerProps) {
  ...
  // 728x90 リーダーボード（3枚目）
  if (size === 'leaderboard3') {
    return (
      <div className={`w-full overflow-x-auto text-center ${className}`}>
        <a
          href="https://px.a8.net/svt/ejp?a8mat=4B3QB0+3ITCMQ+50+7A6FY9"
          rel="nofollow noopener noreferrer"
          target="_blank"
        >
          <img
            ...
            height={90}
            alt=""
            src="https://www27.a8.net/svt/bgt?aid=260514540213&wid=001&eno=01&mid=s00000000018044036000&mc=1"
          />
        </a>
        <img style={{ border: 0 }} width={1} height={1} src="https://www19.a8.net/0.gif?a8mat=4B3QB0+3ITCMQ+50+7A6FY9" alt="" />
      </div>
    )
  }
  ...
  if (size === 'rect3') {
    return (
      <div className={`inline-block w-full max-w-[300px] ${className}`}>
        <a
          href="https://px.a8.net/svt/ejp?a8mat=4B3MES+D6IHWY+5VEK+5YZ75"
          rel="nofollow noopener noreferrer"
          target="_blank"
        >
          <img
            ...
            height={250}
            alt=""
            src="https://www26.a8.net/svt/bgt?aid=260509492797&wid=001&eno=01&mid=s00000027398001003000&mc=1"
          />
        </a>
  ...
  if (size === 'rect5') {
    return (
      <div className={`inline-block w-full max-w-[300px] ${className}`}>
        <a
          href="https://px.a8.net/svt/ejp?a8mat=4B3QB0+3H11TE+5PZK+5YZ75"
          rel="nofollow noopener noreferrer"
          target="_blank"
        >
          <img
            ...
            height={250}
            alt=""
            src="https://www20.a8.net/svt/bgt?aid=260514540210&wid=001&eno=01&mid=s00000026696001003000&mc=1"
          />
        </a>
        <img style={{ border: 0 }} width={1} height={1} src="https://www17.a8.net/0.gif?a8mat=4B3QB0+3H11TE+5PZK+5YZ75" alt="" />
      </div>
    )
  }
  ...
  if (size === 'rect6') {
    return (
      <div className={`inline-block w-full max-w-[336px] ${className}`}>
        <a
          href="https://px.a8.net/svt/ejp?a8mat=4B3QB0+3H11TE+5PZK+61C2P"
          rel="nofollow noopener noreferrer"
          target="_blank"
        >
          <img
            ...
            height={280}
            alt=""
            src="https://www24.a8.net/svt/bgt?aid=260514540210&wid=001&eno=01&mid=s00000026696001014000&mc=1"
          />
        </a>
        <img style={{ border: 0 }} width={1} height={1} src="https://www18.a8.net/0.gif?a8mat=4B3QB0+3H11TE+5PZK+61C2P" alt="" />
      </div>
    )
  }
